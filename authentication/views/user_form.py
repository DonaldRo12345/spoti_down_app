...
class AuthForm(customtkinter.CTk):
    ...
    logo = customtkinter.CTkImage(
        Image.open(settings.BASE_IMAGE_PATH / "mnlv-audio.png"),
        size=(150, 150),
    )
    ...
    def __init__(self):
        ...
        #     self.iconbitmap(settings.BASE_DIR / "icon.ico")
    ...
    def setup_header_logo(self):
        ...
        # self.label.grid(row=0, column=1, sticky=tk.W+tk.E, columnspan=3)
    ...
    def login_form(self):
        ...
        self.email.grid(row=1, column=1, pady=1)
        ...
        self.email_entry.grid(row=1, column=2,  pady=1)
        ...
        self.pwd_label.grid(row=2, column=1, pady=10)
        ...
        #same fg_color with the parent
        color = self.cget("fg_color")
        bouton_frame = customtkinter.CTkFrame(self, fg_color=color)
        ...
        self.register_button.grid(row=1, column=0, pady=5, padx=10)
        bouton_frame.grid(row=3, column=2, pady=10)
    ...
    def register_form(self):
        ...
        self.username_entry.grid(row=2, column=2, pady=5)
        ...
        self.password_entry.grid(row=3, column=2, pady=5)
